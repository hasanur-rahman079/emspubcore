{**
 * plugins/generic/emspubcore/templates/paddleLauncher.tpl
 *
 * Paddle Billing (v2) Checkout Launcher
 *}
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div class="card" id="main-card">
        ...
        <h2 id="status-title">{translate key="plugins.generic.emspubcore.checkout.preparing"}</h2>
        <p id="status-text">{translate key="plugins.generic.emspubcore.checkout.redirecting"}</p>
        
        <div id="error-box" class="error-container">
            <strong>{translate key="common.error"}</strong>
    ...
    <script type="text/javascript">
        function showError(msg) {
            ...
            document.getElementById("status-title").innerText = "{translate key="common.error"}";
